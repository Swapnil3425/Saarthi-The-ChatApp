...
const SaarthiLogo = ({ size = "normal" }) => {
    const isBig = size === "big";
    return (
        <div className={`flex items-center gap-4 ${isBig ? 'mb-4' : ''} group cursor-pointer`}>
            ...
            <div className="flex flex-col">
                ...
                {isBig && (
                    <span className="text-sm sm:text-base text-gray-400 tracking-widest uppercase font-medium mt-2 opacity-80 group-hover:opacity-100 transition-opacity duration-300">
                        Your Own Messenger
                    </span>
                )}
            </div>
